...
public class ProductControllerTest {
    ...
    public void testList() throws Exception {
        ...
        when(productService.listAll()).thenReturn((List) products); //need to strip generics to keep Mockito
        // happy.
    ...
    public void testEdit() throws Exception {
        ...
        when(productToProductForm.convert(any(Product.class))).thenReturn(new ProductForm());
