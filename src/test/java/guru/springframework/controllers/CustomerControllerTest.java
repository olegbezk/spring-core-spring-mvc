...
public class CustomerControllerTest {
    ...
    public void testEdit() throws Exception {
        ...
        when(customerToCustomerForm.convert(eq(customer))).thenReturn(new CustomerForm());
    ...
    public void testSaveOrUpdate() throws Exception {
        ...
        when(customerService.getById(Matchers.<Long>any())).thenReturn(returnCustomer);
